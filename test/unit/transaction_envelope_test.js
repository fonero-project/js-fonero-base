describe('TransactionEnvelope', function() {
  ...
  it("can successfully decode an envelope", function(done) {
    ...
    // from https://github.com/fonero-project/js-fonero-sdk/issues/73
    ...
    var txe = FoneroBase.xdr.TransactionEnvelope.fromXDR(xdr, 'base64');
  ...
  it("calculates correct hash with non-utf8 strings", function() {
    ...
    var tx = new FoneroBase.Transaction(xdr);
