...
describe('FoneroBase#sign', function() {
  ...
  it("can sign an string properly", function() {
    ...
    let actualSig   = FoneroBase.sign(data, secretKey).toString('hex');
...
describe('FoneroBase#verify', function() {
  ...
  it("can verify an string properly", function() {
    let data = "hello world";
    expect(FoneroBase.verify(data, sig, publicKey)).to.be.truthy;
    expect(FoneroBase.verify("corrupted", sig, publicKey)).to.be.falsey;
    expect(FoneroBase.verify(data, badSig, publicKey)).to.be.falsey;
  });
